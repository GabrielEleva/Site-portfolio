...
import type { AuthResponse, BrandSettings, Video, VideoInput } from "@/lib/types";
...
export default function Admin() {
  ...
  const categories = useMemo(() => ["Comerciais", "Videoclipes", "Documentários", "Eventos", "Institucional"], []);
